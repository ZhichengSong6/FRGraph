...
if("TRUE" STREQUAL "TRUE")
  set(planner_manager_SOURCE_PREFIX /home/zhicheng/Project/FRGraph/src/planner_manager)
  set(planner_manager_DEVEL_PREFIX /home/zhicheng/Project/FRGraph/devel/.private/planner_manager)
  ...
  set(planner_manager_INSTALL_PREFIX /home/zhicheng/Project/FRGraph/install)
...
if(NOT "/home/zhicheng/Project/FRGraph/src/planner_manager/include " STREQUAL " ")
  set(planner_manager_INCLUDE_DIRS "")
  set(_include_dirs "/home/zhicheng/Project/FRGraph/src/planner_manager/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'zhicheng <zhicheng@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'planner_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zhicheng/Project/FRGraph/src/planner_manager/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zhicheng/Project/FRGraph/devel/.private/planner_manager/lib;/home/zhicheng/Project/FRGraph/devel/lib;/opt/ros/noetic/lib)
...
set(planner_manager_EXPORTED_TARGETS "")
